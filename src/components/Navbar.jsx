...
const Navbar = ({ isDark, toggleTheme }) => {
  ...
  const sections = ['home', 'about', 'experience', 'projects', 'gallery', 'activities', 'contact'];
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                ...
                className={`text-sm font-medium transition-colors hover:text-black dark:hover:text-white ${activeSection === link.href.substring(1)
          ...
          <div className="px-4 py-3 space-y-3">
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollToSection(e, link.href)}
                className={`block px-3 py-2 rounded-lg text-base font-medium transition-colors ${activeSection === link.href.substring(1)
